            ...
            <div class="iq-card">
                <div class="iq-card-body profile-page">
                    ...
                    <div class="cover-container text-center">
                        <img src="{{ asset('/'.$user->profile->image) }}" alt="profile-bg" class="avatar-100 rounded-circle img-fluid">
                        ...
                        <div class="iq-social d-inline-block align-items-center">
                            <ul class="list-inline d-flex p-0 mb-0 align-items-center">
                                <li>
                                <a href="{{ $user->facebookLink }}" class="avatar-40 rounded-circle bg-primary mr-2 facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                </li>
                                <li>
                                <a href="{{ $user->twitterLink }}" class="avatar-40 rounded-circle bg-primary mr-2 twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                </li>
                                <li>
                                <a href="{{ $user->youtubeLink }}" class="avatar-40 rounded-circle bg-primary mr-2 youtube"><i class="fa fa-youtube-play" aria-hidden="true"></i></a>
                                </li>
                                <li >
                                <a href="{{ $user->instagramLink }}" class="avatar-40 rounded-circle bg-primary pinterest"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="iq-card-body">
                    ...
                    <li>
                        <div class="row align-items-center justify-content-between mb-3">
                            ...
                            <div class="col-sm-6">
                                <p class="mb-0">{{ $user->profile->birthDate }}</p>                                       
                            </div>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <div class="row align-items-center justify-content-between mb-3">
                            ...
                            <div class="col-sm-6">
                                <p class="mb-0">{{ $user->profile->mobileNo }}</p>                                       
                            </div>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <div class="row align-items-center justify-content-between mb-3">
                            ...
                            <div class="col-sm-6">
                                <p class="mb-0">{{ $user->twitterLink }}</p>                                       
                            </div>
                        </div>
                    </li>                              
                    <li>
                        <div class="row align-items-center justify-content-between mb-3">
                            ...
                            <div class="col-sm-6">
                                <p class="mb-0">{{ $user->facebookLink }}</p>                                       
                            </div>
                        </div>
                    </li>
                    </ul>
